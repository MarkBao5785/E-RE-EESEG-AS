...
class EE_Net:
    def __init__(self, dim, n_arm, pool_step_size, lr_1 = 0.01, lr_2 = 0.01, lr_3 = 0.01, hidden=100,_kernel_size=100, _stride=50, neural_decision_maker = False):
        #Network 1
        ...
        #Network 2
        self.f_2 = Exploration(f_2_input_dim, lr_2,_kernel_size, _stride)
