...
if __name__ == '__main__':
    ...
    for i in range(runing_times):  
        ...
        regrets = []
        sum_regret = 0
        ee_net = EE_Net(b.dim, b.n_arm, pool_step_size = 50, lr_1 = lr_1, lr_2 = lr_2, lr_3 = lr_3,  hidden=100, neural_decision_maker = True)
    ...
    path = os.getcwd()
    np.save('{}/results/eenet_results_neu.npy'.format(path), regrets_all)