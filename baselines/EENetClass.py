...
class Exploration:
    def __init__(self, input_dim, lr, _kernel_size, _stride):
        self.func = Network_exploration(input_dim=input_dim, _kernel_size=_kernel_size, _stride=_stride).to(device)
        self.context_list = []
        self.reward = []
        self.lr = lr
